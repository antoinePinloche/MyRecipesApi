...
namespace MyRecipes.Database.Migrations
{
    ...
    [Migration("20230621003026_InitMigrationa")]
            ...
            modelBuilder.Entity("MyRecipes.Database.EntityModels.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nationality = "ASIA",
                            RecipesUserId = 1,
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1768)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Nationality = "ITALIA",
                            RecipesUserId = 1,
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1769)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            RecipesUserId = 2,
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1771)
                        });
                });
            ...
            modelBuilder.Entity("MyRecipes.Database.EntityModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "password",
                            Role = "ADMIN",
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1663),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            Password = "password",
                            Role = "USER",
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1754),
                            UserName = "user"
                        },
                        new
                        {
                            ...
                            Password = "string",
                            Role = "USER",
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1762),
                            UserName = "Batman"
                        },
                        new
                        {
                            ...
                            Password = "string",
                            Role = "ADMIN",
                            StartDate = new DateTime(2023, 6, 21, 2, 30, 26, 137, DateTimeKind.Local).AddTicks(1758),
                            UserName = "string"
                        });
                });
