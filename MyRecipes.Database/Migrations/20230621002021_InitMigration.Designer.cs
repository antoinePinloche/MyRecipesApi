...
namespace MyRecipes.Database.Migrations
{
    ...
    [Migration("20230621002021_InitMigration")]
            ...
            modelBuilder.Entity("MyRecipes.Database.EntityModels.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nationality = "ASIA",
                            RecipesUserId = 1,
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2618)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Nationality = "ITALIA",
                            RecipesUserId = 1,
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2620)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            RecipesUserId = 2,
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2621)
                        });
                });
            ...
            modelBuilder.Entity("MyRecipes.Database.EntityModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "password",
                            Role = "ADMIN",
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2548),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            Password = "password",
                            Role = "USER",
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2610),
                            UserName = "user"
                        },
                        new
                        {
                            ...
                            Password = "string",
                            Role = "USER",
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2614),
                            UserName = "Batman"
                        },
                        new
                        {
                            ...
                            Password = "string",
                            Role = "ADMIN",
                            StartDate = new DateTime(2023, 6, 21, 2, 20, 20, 881, DateTimeKind.Local).AddTicks(2612),
                            UserName = "string"
                        });
                });
