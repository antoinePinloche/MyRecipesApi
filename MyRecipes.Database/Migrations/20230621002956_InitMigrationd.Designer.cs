...
namespace MyRecipes.Database.Migrations
{
    ...
    [Migration("20230621002956_InitMigrationd")]
    partial class InitMigrationd
    {
            ...
            modelBuilder.Entity("MyRecipes.Database.EntityModels.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nationality = "ASIA",
                            RecipesUserId = 1,
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3777)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Nationality = "ITALIA",
                            RecipesUserId = 1,
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3779)
                        },
                        new
                        {
                            Id = 3,
                            Description = "Semoule Carrote a la maraaine",
                            Name = "SemouleMarocain",
                            Nationality = "Marocain",
                            RecipesUserId = 2,
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3781)
                        });
                });
            ...
            modelBuilder.Entity("MyRecipes.Database.EntityModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "password",
                            Role = "ADMIN",
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3742),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            Password = "password",
                            Role = "USER",
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3770),
                            UserName = "user"
                        },
                        new
                        {
                            ...
                            Password = "string",
                            Role = "USER",
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3774),
                            UserName = "Batman"
                        },
                        new
                        {
                            ...
                            Password = "string",
                            Role = "ADMIN",
                            StartDate = new DateTime(2023, 6, 21, 2, 29, 56, 563, DateTimeKind.Local).AddTicks(3772),
                            UserName = "string"
                        });
                });
